...
/*   Updated: 2024/06/14 15:10:45 by asideris         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ft_push_a_to_b(Node **a, Node **b)
{
    ...
    if (cheapest_node->over_middle == 1 && cheapest_node->best_friend->over_middle == 1)
    {
    ...
    else if (cheapest_node->over_middle == 0 && cheapest_node->best_friend->over_middle == 0)
    {
        while (*a != cheapest_node && *b != cheapest_node->best_friend)
        {
            ft_rev_rot_both(a, b);
